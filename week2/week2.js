...
for(i=0; i<order.length; i++){
    ...
    if(reserves2.includes(order[i])){
        order2.push(order[i])
    }
    if(reserves3.includes(order[i])){
        order3.push(order[i])
    }
}
...
if(cut1[0]==="c" && Number(cut1[1])<=1200){
    for(i=0; i<services.length; i++){
        if(services[i].c >= Number(cut1[1]) && orderarr[i].length==0){
    ...
    for(i=0; i<services.length; i++){
        if(services[i].r >= Number(cut1[1]) && orderarr[i].length==0){
    ...
    for(i=0; i<services.length; i++){
        if(services[i].c <= Number(cut2[1]) && orderarr[i].length==0){
            result.push(services[i].c)
        }
    }
    if (result.length==0){
    ...
    for(i=0; i<services.length; i++){
        if(services[i].r <= Number(cut2[1]) && orderarr[i].length==0){
            result.push(services[i].r)
        }
    }
    if (result.length==0){
    ...
    for(i=0; i<services.length; i++ ){
        if(cut3[1]==services[i].name && orderarr[i].length==0){
            answer=services[i].name
            break
        }
    }
